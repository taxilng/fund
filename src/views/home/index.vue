<template>
    <div id="app" class="container" :class="containerClass" :style="
      diyContainer
    ...
    ">
        <div class="main-row">
            ...
            <div v-if="isEdit" class="input-row">
                ...
                <el-select v-model="fundcode" multiple filterable :popper-append-to-body="false" remote size="mini" reserve-keyword @visible-change="selectChange" placeholder="请输入基金编码，支持按名称或编码搜索" :remote-method="remoteMethod" :loading="loading" style="width:300px">
            ...
            <div class="table-row" :class="tableHeight">
                ...
                " :title="el.name" @click.stop="!isEdit && fundDetail(el)">
                                {{ el.name }}
                            </td>
        ...
        remoteMethod (query) {
            if (query !== "") {
                ...
                let url =
                    ...
                    "/fundsuggest/FundSearch/api/FundSearchAPI.ashx?&m=9&key=" +
                    query +
                    "&_=" +
                    new Date().getTime();
