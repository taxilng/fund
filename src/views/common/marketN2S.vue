...
export default {
  ...
  methods: {
    ...
    getData() {
      this.loading = true;
      let url = `/api/qt/kamt.rtmin/get?fields1=f1,f2,f3,f4&fields2=f51,f52,f53,f54,f55,f56&ut=&?v=${new Date().getTime()}`;
      this.$axios.get(url).then((res) => {
        this.loading = false;
        let data = res.data;
        // console.log(data.n2sDate, data.n2s);
        ...
        if (dataList) {
          dataList.forEach((el) => {
            ...
            data2.push((arr[2] / 10000).toFixed(4));
            data3.push((arr[3] / 10000).toFixed(4));
            data4.push((arr[4] / 10000).toFixed(4));
